                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="firstRow">
                        ...
                        <div className="date">
                            ...
                            <InputDate date={editVaccine ? editVaccine?.apply_date : applyDate}
                                       setDate={handleApplyDate} name={"date1"} id={"date1"} register={register}
                                       errors={errors.date1}/>
                        </div>
                    </div>
                    <div className="val">
                        <div className="valid date">
                            ...
                            <InputDate date={validDate} setDate={handleValidDate} name={"date2"} register={register}
                                       errors={errors.date2} id={"date2"}/>
                        </div>
