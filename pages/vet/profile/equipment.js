                ...
                {pending ? (
                    <Loader />
                        ...
                        <React.Fragment>
                            <h1>Můj profil</h1>
                            <Tabs activeTab={3} />
                            <PropertiesForm propertyType="equipment" propertyId={1} userId={doctor.id} property={doctor.properties.equipment} title="Vybavení ordinace" />
                        </React.Fragment>
                    )}
            </div>
        </Layout>
...
export default withRedux(withVetRoute(withNotie(Equipment)));
